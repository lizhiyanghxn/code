...
var _CardLoading = _interopRequireDefault(require("./components/CardLoading"));
...
var useBreakpoint = _grid.default.useBreakpoint; // @ts-ignore

var ProCard = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  ...
  var childrenModified = childrenArray.map(function (element, index) {
    ...
    if (element === null || element === void 0 ? void 0 : (_element$type = element.type) === null || _element$type === void 0 ? void 0 : _element$type.isProCard) {
      ...
      return /*#__PURE__*/_react.default.cloneElement(element, {
        className: (0, _classnames.default)(element.props.className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-split-vertical"), split === 'vertical' && index !== childrenArray.length - 1), _defineProperty(_classNames, "".concat(prefixCls, "-split-horizontal"), split === 'horizontal' && index !== childrenArray.length - 1), _classNames)),
  ...
  var cardCls = (0, _classnames.default)("".concat(prefixCls), className, (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-span-").concat(span), typeof span === 'number' && span >= 0 && span <= 24), _defineProperty(_classNames2, "".concat(prefixCls, "-border"), bordered), _defineProperty(_classNames2, "".concat(prefixCls, "-contain-card"), containProCard), _defineProperty(_classNames2, "".concat(prefixCls, "-loading"), loading), _defineProperty(_classNames2, "".concat(prefixCls, "-split"), split === 'vertical' || split === 'horizontal'), _defineProperty(_classNames2, "".concat(prefixCls, "-ghost"), ghost), _defineProperty(_classNames2, "".concat(prefixCls, "-hoverable"), hoverable), _defineProperty(_classNames2, "".concat(prefixCls, "-size-").concat(size), size), _defineProperty(_classNames2, "".concat(prefixCls, "-type-").concat(type), type), _defineProperty(_classNames2, "".concat(prefixCls, "-collapse"), collapsed), _classNames2));
  var headerCls = (0, _classnames.default)("".concat(prefixCls, "-header"), _defineProperty({}, "".concat(prefixCls, "-header-border"), headerBordered || type === 'inner'));
  var bodyCls = (0, _classnames.default)("".concat(prefixCls, "-body"), (_classNames4 = {}, _defineProperty(_classNames4, "".concat(prefixCls, "-body-center"), layout === 'center'), _defineProperty(_classNames4, "".concat(prefixCls, "-body-column"), split === 'horizontal' || direction === 'column'), _classNames4));
  var loadingBlockStyle = bodyStyle.padding === 0 || bodyStyle.padding === '0px' ? {
    padding: 24
  } : undefined;
  var loadingDOM = /*#__PURE__*/_react.default.isValidElement(loading) ? loading : /*#__PURE__*/_react.default.createElement(_CardLoading.default, {
    prefix: prefixCls,
  ...
  var titleCls = (0, _classnames.default)("".concat(prefixCls, "-title"), _defineProperty({}, "".concat(prefixCls, "-title-collapsible"), collapsibleButton));
  /** 操作按钮 */

  var actionDom = /*#__PURE__*/_react.default.createElement(_Actions.default, {
    actions: actions,
    prefixCls: prefixCls
  });
  ...
  return /*#__PURE__*/_react.default.createElement("div", _extends({
    ...
    style: cardStyle,
    ref: ref
  }, (0, _omit.default)(rest, ['id', 'prefixCls'])), (title || extra || collapsibleButton) && /*#__PURE__*/_react.default.createElement("div", {
    className: headerCls,
    style: headStyle
  ...
  }, collapsibleButton, /*#__PURE__*/_react.default.createElement(_dcpUtils.LabelIconTip, {
    label: title,
    tooltip: tooltip || tip,
    subTitle: subTitle
  })), /*#__PURE__*/_react.default.createElement("div", {
...
var Group = function Group(props) {
  return /*#__PURE__*/_react.default.createElement(ProCard, _extends({
    bodyStyle: {
      padding: 0
    }
  }, props));
