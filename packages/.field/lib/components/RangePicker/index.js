...
var FieldRangePicker = function FieldRangePicker(_ref, ref) {
  ...
  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement("div", {
      ref: ref
    }, /*#__PURE__*/_react.default.createElement("div", null, parsedStartText || '-'), /*#__PURE__*/_react.default.createElement("div", null, parsedEndText || '-'));
  ...
  if (mode === 'edit' || mode === 'update') {
    var momentValue = (0, _dcpUtils.parseValueToMoment)(fieldProps.value);

    var _dom = /*#__PURE__*/_react.default.createElement(_datePicker.default.RangePicker, _extends({
      ref: ref,
      format: format,
      showTime: showTime,
