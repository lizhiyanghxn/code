...
import type { ProFieldRequestData, ProFieldValueEnumType, ProSchemaValueEnumMap } from '@dcp-fe/dcp-utils';
...
declare const _default: React.ForwardRefExoticComponent<import("@dcp-fe/dcp-provider").BaseProFieldFC & import("@dcp-fe/dcp-provider").ProRenderFieldPropsType & FieldSelectProps & React.RefAttributes<any>>;
