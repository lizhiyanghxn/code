...
var useFieldFetchData = function useFieldFetchData(props) {
  ...
  var getOptionsFormValueEnum = (0, _react.useCallback)(function (valueEnum) {
    return proFieldParsingValueEnumToArray(ObjToMap(valueEnum)).map(function (_ref) {
      var value = _ref.value,
          text = _ref.text,
          rest = _objectWithoutProperties(_ref, ["value", "text"]);
  ...
  var _useSWR = (0, _swr.default)([proFieldKeyRef.current, JSON.stringify(props.params)], /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var fetchData;
  ...
  return [loading, props.request ? data : options, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var fetchData;
