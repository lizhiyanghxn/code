...
function createField(Field, config) {
  var FieldWithContext = function FieldWithContext(props) {
    ...
    var restFormItemProps = (0, _dcpUtils.pickProFormItemProps)(rest);
    var formNeedProps = {
      value: rest.value,
    ...
    , _extends({}, rest, {
      fieldProps: (0, _dcpUtils.omitUndefined)(_objectSpread(_objectSpread({
        allowClear: allowClear
      }, realFieldProps), {}, {
        style: (0, _dcpUtils.omitUndefined)(_objectSpread({
      ...
      proFieldProps: (0, _dcpUtils.omitUndefined)(_objectSpread({
