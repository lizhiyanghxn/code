...
var QueryFilterContent = function QueryFilterContent(props) {
  ...
  var submitter = (0, _react.useMemo)(function () {
    ...
    return /*#__PURE__*/_react.default.cloneElement(props.submitter, _objectSpread({
      searchConfig: {
        resetText: resetText,
  ...
  var doms = flatMapItems(items, props.ignoreRules).map(function (item, index) {
    ...
    var colSize = /*#__PURE__*/_react.default.isValidElement(item) ? item === null || item === void 0 ? void 0 : (_item$props4 = item.props) === null || _item$props4 === void 0 ? void 0 : _item$props4.colSize : 1;
...
var defaultWidth = (0, _dcpUtils.isBrowser)() ? 0 : 1024;
...
function QueryFilter(props) {
  ...
  var _useMountMergeState = (0, _dcpUtils.useMountMergeState)(function () {
  ...
  var labelFlexStyle = (0, _react.useMemo)(function () {
  ...
  }, /*#__PURE__*/_react.default.createElement(_BaseForm.default, _extends({
    preserve: preserve
  }, rest, {
    onReset: onReset,
    style: style,
