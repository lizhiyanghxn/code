...
var getFormCompetent = function getFormCompetent(isForm, searchConfig) {
  if (!isForm && searchConfig !== false) {
    if ((searchConfig === null || searchConfig === void 0 ? void 0 : searchConfig.filterType) === 'light') {
      return {
        Competent: _dcpForm.LightFilter,
        competentName: 'light-filter'
      };
    }

    return {
      Competent: _dcpForm.QueryFilter,
      competentName: 'query-filter'
    };
  }

  return {
    Competent: _dcpForm.default,
    competentName: 'form'
  };
};
/**
...
var formInputRender = function formInputRender(props, ref) {
  ...
  var formItemProps = (0, _dcpUtils.getFieldPropsOrFormItemProps)(propsFormItemProps, form, item);
  ...
  var _getFieldPropsOrFormI = (0, _dcpUtils.getFieldPropsOrFormItemProps)(item.fieldProps || {}, form, item),
  ...
  if (item.renderFormItem && form) {
    ...
    var renderFormItemProps = (0, _omit.default)(_objectSpread(_objectSpread({}, rest), {}, {
      type: type,
    ...
    return /*#__PURE__*/_react.default.createElement(_dcpForm.ProFormField, _extends({}, rest, initialProps, {
      ref: ref,
    ...
    }), /*#__PURE__*/_react.default.cloneElement(dom, (0, _omit.default)(_objectSpread(_objectSpread({}, rest), defaultProps), ['colSize'])));
  }

  var finalValueType = !valueType || ['textarea', 'jsonCode', 'code'].includes(valueType) && type === 'table' ? 'text' : valueType;
  return /*#__PURE__*/_react.default.createElement(_dcpForm.ProFormField, _extends({
    ref: ref,
    tooltip: item.tooltip || item.tip,
    isDefaultDom: true,
    valueEnum: (0, _dcpUtils.runFunction)(item.valueEnum, undefined),
    onChange: onChange,
    fieldProps: _objectSpread({
      style: {
        width: undefined
...
var FormSearch = function FormSearch(_ref2) {
  ...
  var columnsListRef = (0, _react.useRef)([]);
  var updateDomList = (0, _react.useCallback)(function (list) {
  ...
  (0, _dcpUtils.useDeepCompareEffect)(function () {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)(className, (_classNames = {}, _defineProperty(_classNames, formClassName, isForm), _defineProperty(_classNames, getPrefixCls("pro-table-search-".concat(competentName)), true), _defineProperty(_classNames, "".concat(getPrefixCls('card'), "-bordered"), !!bordered), _classNames))
  }, /*#__PURE__*/_react.default.createElement(Competent, _extends({}, loadingProps, getFromProps(isForm, searchConfig, competentName), getFormConfigs(isForm, formConfig), {
    formRef: formRef,
...
var _default = /*#__PURE__*/_react.default.memo(FormSearch);
