...
exports.default = exports.DeleteEditableAction = exports.SaveEditableAction = exports.recordKeyToString = exports.toNumber = void 0;
...
var toNumber = function toNumber(recordKey) {
...
var SaveEditableAction = function SaveEditableAction(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              record = isMapEditor ? (0, _set.default)(row, namePath, fields) : _objectSpread(_objectSpread({}, row), fields);
              _context.next = 10;
...
function defaultActionRender(row, config) {
  ...
  return [/*#__PURE__*/_react.default.createElement(SaveEditableAction, _extends({
    ...
    row: row
  }), deleteText) : null, /*#__PURE__*/_react.default.createElement("a", {
    key: "cancel",
