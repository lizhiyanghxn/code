...
var FieldRender = function FieldRender(props) {
  ...
  if (mode === 'read' || !mode || valueType === 'option') {
    var fieldProps = (0, _dcpUtils.getFieldPropsOrFormItemProps)(props.fieldProps, undefined, _objectSpread(_objectSpread({}, props), {}, {
      rowKey: dataIndex,
      isEditable: false
    }));
    return /*#__PURE__*/_react.default.createElement(_dcpForm.ProFormField, _extends({}, fieldConfig, {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    var formItemProps = (0, _dcpUtils.getFieldPropsOrFormItemProps)(props.formItemProps, form, _objectSpread(_objectSpread({}, props), {}, {
      rowKey: dataIndex,
      isEditable: true
    }));
    var fieldProps = (0, _dcpUtils.getFieldPropsOrFormItemProps)(props.fieldProps, form, _objectSpread(_objectSpread({}, props), {}, {
      rowKey: dataIndex,
      isEditable: true
    }));
    ...
    return /*#__PURE__*/_react.default.createElement(_space.default, null, /*#__PURE__*/_react.default.createElement(_dcpUtils.InlineErrorFormItem, _extends({
      style: {
        margin: 0
      },
      name: dataIndex
    ...
    }), dom || /*#__PURE__*/_react.default.createElement(_dcpForm.ProFormField, _extends({}, fieldConfig, {
      // @ts-ignore
...
var schemaToDescriptionsItem = function schemaToDescriptionsItem(items, entity, action, editableUtils) {
  ...
  var children = items === null || items === void 0 ? void 0 : (_items$map = items.map) === null || _items$map === void 0 ? void 0 : _items$map.call(items, function (item, index) {
    ...
    var field = /*#__PURE__*/_react.default.createElement(_descriptions.default.Item, _extends({}, restItem, {
      ...
      label: /*#__PURE__*/_react.default.createElement(_dcpUtils.LabelIconTip, {
...
var ProDescriptions = function ProDescriptions(props) {
  ...
  var editableUtils = (0, _dcpUtils.useEditableMap)(_objectSpread(_objectSpread({}, props.editable), {}, {
  ...
  if (action.loading || action.loading === undefined && request) {
    return /*#__PURE__*/_react.default.createElement(_dcpSkeleton.default, {
      type: "descriptions",
      list: false,
      pageHeader: false
    });
  ...
  var FormComponent = editable ? _dcpForm.default : function (dom) {
    return dom.children;
  };
  ...
  if (rest.title || rest.tooltip || rest.tip) {
    title = /*#__PURE__*/_react.default.createElement(_dcpUtils.LabelIconTip, {
      label: rest.title,
  ...
  return /*#__PURE__*/_react.default.createElement(_dcpUtils.ErrorBoundary, null, /*#__PURE__*/_react.default.createElement(FormComponent, _extends({
