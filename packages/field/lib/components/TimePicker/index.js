...
var FieldTimePicker = function FieldTimePicker(_ref, ref) {
  ...
  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement("span", {
      ref: ref
    }, text ? (0, _moment.default)(text).format(format || 'HH:mm:ss') : '-');
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var momentValue = (0, _dcpUtils.parseValueToMoment)(value);
    ...
    if (light) {
      ...
      _dom = /*#__PURE__*/_react.default.createElement("div", {
      ...
      }, /*#__PURE__*/_react.default.createElement(_timePicker.default, _extends({
        value: momentValue,
        format: format,
        ref: ref
      }, fieldProps, {
        ...
        open: open
      })), /*#__PURE__*/_react.default.createElement(_dcpUtils.FieldLabel, {
        label: label,
        disabled: disabled,
...
var FieldTimeRangePicker = function FieldTimeRangePicker(_ref2) {
  ...
  var parsedStartText = startText ? (0, _moment.default)(startText).format(format || 'YYYY-MM-DD') : '';
  var parsedEndText = endText ? (0, _moment.default)(endText).format(format || 'YYYY-MM-DD') : '';

  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", null, parsedStartText || '-'), /*#__PURE__*/_react.default.createElement("div", null, parsedEndText || '-'));
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var _dom2 = /*#__PURE__*/_react.default.createElement(_timePicker.default.RangePicker, _extends({
      format: format,
      bordered: plain === undefined ? true : !plain
    }, fieldProps, {
      value: momentValue
