...
var LightWrapper = function LightWrapper(props) {
  ...
  var isDropdown = /*#__PURE__*/_react.default.isValidElement(children) && (0, _dcpUtils.isDropdownValueType)(children.props.valueType);

  if (!light || customLightMode || isDropdown) {
    if ( /*#__PURE__*/_react.default.isValidElement(children)) {
      return /*#__PURE__*/_react.default.cloneElement(children, (0, _dcpUtils.omitUndefined)(_objectSpread(_objectSpread({
        value: value,
        onChange: onChange,
        onBlur: onBlur
      }, children.props), {}, {
        fieldProps: (0, _dcpUtils.omitUndefined)(_objectSpread(_objectSpread(_defineProperty({
          id: id
  ...
  return /*#__PURE__*/_react.default.createElement(_dcpUtils.FilterDropdown, {
    disabled: disabled,
    onVisibleChange: setOpen,
    visible: open,
    label: /*#__PURE__*/_react.default.createElement(_dcpUtils.FieldLabel, {
      ellipsis: true,
      size: size,
