...
```tsx | pure
import { RouteContext, RouteContextType } from '@dcp-fe/dcp-layout';
...
```js | pure
import { getMenuData } from '@dcp-fe/dcp-layout';
...
```js | pure
import { getPageTitle } from '@dcp-fe/dcp-layout';
...
```ts | pure
// 可以通过 import { Settings } from '@dcp-fe/dcp-layout/defaultSettings'
// 来获取这个类型
...
```ts | pure
// 可以通过 import { MenuDataItem } from '@dcp-fe/dcp-layout'
// 来获取这个类型
...
```ts | pure
// 可以通过 import { RouterTypes } from '@dcp-fe/dcp-layout/lib/typings';
// 来获取这个类型
