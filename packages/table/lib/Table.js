...
var ProTable = function ProTable(props) {
  ...
  var _useMountMergeState = (0, _dcpUtils.useMountMergeState)([], {
  ...
  var _useMountMergeState3 = (0, _dcpUtils.useMountMergeState)([]),
  ...
  var _useMountMergeState5 = (0, _dcpUtils.useMountMergeState)(function () {
  ...
  var _useMountMergeState7 = (0, _dcpUtils.useMountMergeState)({}),
  ...
  var _useMountMergeState9 = (0, _dcpUtils.useMountMergeState)({}),
  ...
  var editableUtils = (0, _dcpUtils.useEditableArray)(_objectSpread(_objectSpread({}, props.editable), {}, {
    getRowKey: getRowKey,
  ...
  var searchNode = (0, _react.useMemo)(function () {
    ...
    var onSubmit = function onSubmit(value, firstLoad) {
      if (type !== 'form') {
        ...
        var pageInfo = pagination ? (0, _dcpUtils.omitUndefined)({
  ...
  var toolbarDom = (0, _react.useMemo)(function () {
    ...
    var onSearch = function onSearch(keyword) {
      ...
      setFormSearch((0, _dcpUtils.omitUndefined)(_objectSpread(_objectSpread({}, formSearch), {}, _defineProperty({
        _timestamp: Date.now()
      }, name, keyword))));
    };
  ...
  var getTableProps = function getTableProps() {
    return _objectSpread(_objectSpread({}, rest), {}, {
      ...
      onChange: function onChange(changePagination, filters, sorter, extra) {
        ...
        if (!useLocaleFilter) {
          setProFilter((0, _dcpUtils.omitUndefined)(filters));
        } // 制造筛选的数据
        // 制造一个排序的数据
        ...
        if (Array.isArray(sorter)) {
          ...
          setProSort((0, _dcpUtils.omitUndefined)(data));
        } else {
          setProSort((0, _dcpUtils.omitUndefined)(_defineProperty({}, "".concat(sorter.field), sorter.order)));
        }
      }
    });
  };
...
var ProviderWarp = function ProviderWarp(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_container.default.Provider, {
    initialState: props
  }, /*#__PURE__*/_react.default.createElement(_dcpProvider.ConfigProviderWrap, null, /*#__PURE__*/_react.default.createElement(_dcpUtils.ErrorBoundary, null, /*#__PURE__*/_react.default.createElement(ProTable, _extends({
