...
exports.default = exports.spellNamePath = void 0;
...
var spellNamePath = function spellNamePath(base, dataIndex) {
...
function defaultRenderText(config) {
  ...
  var proFieldProps = {
    valueEnum: (0, _dcpUtils.runFunction)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.valueEnum, rowData),
  ...
  if (config.mode !== 'edit') {
    return /*#__PURE__*/_react.default.createElement(_dcpField.default, _extends({
      fieldProps: (0, _dcpUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.fieldProps, null, columnProps)
    }, proFieldProps));
  ...
  return /*#__PURE__*/_react.default.createElement(_form.default.Item, {
    ...
    var formItemProps = (0, _dcpUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.formItemProps, form, _objectSpread(_objectSpread({
    ...
    var inputDom = /*#__PURE__*/_react.default.createElement(_dcpUtils.InlineErrorFormItem, _extends({
      name: name
    }, formItemProps, {
      messageVariables: messageVariables,
      initialValue: text || (formItemProps === null || formItemProps === void 0 ? void 0 : formItemProps.initialValue)
    }), /*#__PURE__*/_react.default.createElement(_dcpField.default, _extends({
      fieldProps: (0, _dcpUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.fieldProps, form, _objectSpread(_objectSpread({}, columnProps), {}, {
        rowKey: config.recordKey || config.index,
        rowIndex: config.index,
        isEditable: true
      }))
    ...
    if (columnProps === null || columnProps === void 0 ? void 0 : columnProps.renderFormItem) {
      ...
      return /*#__PURE__*/_react.default.createElement(_dcpUtils.InlineErrorFormItem, _extends({
