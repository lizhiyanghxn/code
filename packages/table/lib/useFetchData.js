...
var useFetchData = function useFetchData(getData, defaultData, options) {
  ...
  var _useMountMergeState = (0, _dcpUtils.useMountMergeState)(defaultData, {
  ...
  var _useMountMergeState7 = (0, _dcpUtils.useMountMergeState)(false),
  ...
  var prePage = (0, _dcpUtils.usePrevious)(pageInfo.current);
  var prePageSize = (0, _dcpUtils.usePrevious)(pageInfo.pageSize);
  var prePolling = (0, _dcpUtils.usePrevious)(polling);
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 25:
              responseData = (0, _utils.postDataPipeline)(data, [options.postData].filter(function (item) {
                return item;
              }));
  ...
  var fetchListDebounce = (0, _dcpUtils.useDebounceFn)( /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              // 放到请求前面会导致数据是上一次的
              needPolling = (0, _dcpUtils.runFunction)(polling, msg); // 如果需要轮询，搞个一段时间后执行
  ...
  }(), [manualRequestRef.current], debounceTime); // 如果轮询结束了，直接销毁定时器
