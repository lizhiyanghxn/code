...
exports.genColumnList = genColumnList;
exports.defaultOnFilter = exports.renderColumnsTitle = exports.tableColumnSort = exports.genCopyable = exports.genEllipsis = exports.genColumnKey = exports.checkUndefinedOrNull = void 0;
...
var tableColumnSort = function tableColumnSort(columnsMap) {
  return function (a, b) {
...
exports.tableColumnSort = tableColumnSort;

var renderColumnsTitle = function renderColumnsTitle(item) {
  var title = item.title;

  if (title && typeof title === 'function') {
    return title(item, 'table', /*#__PURE__*/_react.default.createElement(_dcpUtils.LabelIconTip, {
      label: title,
      tooltip: item.tooltip || item.tip
    }));
  }

  return /*#__PURE__*/_react.default.createElement(_dcpUtils.LabelIconTip, {
    label: title,
    tooltip: item.tooltip || item.tip
  });
};
...
function columnRender(_ref) {
  ...
  var textDom = (0, _defaultRender.default)({
    text: renderTextStr,
  ...
  var dom = mode === 'edit' ? textDom : genEllipsis(genCopyable(textDom, columnProps, renderTextStr), columnProps, renderTextStr);
  ...
  return !(0, _dcpUtils.isNil)(dom) ? dom : null;
}
/**
...
function genColumnList(props) {
  ...
  return columns.map(function (columnProps, columnsIndex) {
    ...
    var genOnFilter = function genOnFilter() {
      ...
      return (0, _dcpUtils.omitBoolean)(onFilter);
    };
    ...
    var tempColumns = _objectSpread(_objectSpread({
      ...
      valueEnum: valueEnum,
      filters: filters === true ? (0, _dcpField.proFieldParsingValueEnumToArray)((0, _dcpUtils.runFunction)(valueEnum, undefined)).filter(function (valueItem) {
    ...
    return (0, _dcpUtils.omitUndefinedAndEmptyArr)(tempColumns);
